...
from qwen_upcycle_parallel.configuration_qwen2_vl_moe_parallel import Qwen2VLConfig, Qwen2VLVisionConfig
from qwen_upcycle_parallel.modeling_qwen2_vl_parallel import Qwen2VLForConditionalGeneration
...
def main():
    ...
    vision_config = Qwen2VLVisionConfig.from_pretrained("Qwen/Qwen2-VL-2B-Instruct")
    vision_config.moe_dtype = "bfloat16"
    vision_config.lora_r = 4
    vision_config.lora_alpha = 4
